...
const services = [
  ...
  },
  {
    ...
    items: ["Lease Abstraction & Audit", "Appraisal & OM Data Digitization", "Legacy Data Migration"],
  },
  {
    title: "Consulting & Technology Solutions",
    items: ["Salesforce Customisation & Integration", "Custom Reporting & Dashboards", "CRE Technology Consulting"],
  },
]
